...
from datasets import TgDataset
...
if __name__ == '__main__':
    ...
    parser.add_argument('-t', '--target', type=str, required=True, help='Specify which endpoint dataset to run the model on. Limited to tg for now.', default='tg')
